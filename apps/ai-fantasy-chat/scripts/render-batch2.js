...
const MOOD_WARM = path.join(APP_POSTS_DIR, '2026-03-01/raw-mood.png');
const MOOD_COLD = path.join(APP_POSTS_DIR, '2026-03-02/raw-mood.png');

const POSTS = [
  {
    dir: path.join(APP_POSTS_DIR, '2026-03-08-tonight'),
    mood: MOOD_WARM,
    slides: [
  ...
  {
    dir: path.join(APP_POSTS_DIR, '2026-03-09-a'),
    mood: MOOD_WARM,
    slides: [
  ...
  {
    dir: path.join(APP_POSTS_DIR, '2026-03-09-b'),
    mood: MOOD_COLD,
    slides: [
