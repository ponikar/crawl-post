...
const MOOD_WARM = path.join(APP_POSTS_DIR, '2026-03-01/raw-mood.png'); // warm, dark bedroom
const MOOD_COLD = path.join(APP_POSTS_DIR, '2026-03-02/raw-mood.png'); // cold blue glow, restless

const POSTS = [
  {
    dir: path.join(APP_POSTS_DIR, '2026-03-10-b'),
    mood: MOOD_WARM,
    slides: [
  ...
  {
    dir: path.join(APP_POSTS_DIR, '2026-03-10-c'),
    mood: MOOD_COLD,
    slides: [
      // Slide 1 — hook overlay
